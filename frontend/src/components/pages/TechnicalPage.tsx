...
import OverviewTab from "./technical/OverviewTab";
import IngestionTab from "./technical/IngestionTab";
import QueryTab from "./technical/QueryTab";
import ConfigTab from "./technical/ConfigTab";
